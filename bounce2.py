...
# NEW SPEED CONTROLS
# =====================================================
SPEED_BOOST = 1.05  # Increased from 1.02 to 1.05 (5% faster EVERY bounce)
MAX_SPEED = 7000    # Capped so it doesn't teleport through the wall
...
BURST_TIME_MS = 52000  # 52 seconds
...
while running:
    ...
    if game_state == "PLAYING":
        ...
        if distance + BALL_RADIUS >= CIRCLE_RADIUS:
            ...
            # =============================================
            # APPLY AGGRESSIVE SPEED BOOST & SPEED LIMIT
            # =============================================
