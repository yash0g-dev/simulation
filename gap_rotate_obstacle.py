...
# Walls
# Finish gap
gap_top = HEIGHT // 2 - 100
gap_bottom = HEIGHT // 2 + 200
...
walls = [
    ...
    # Finish wall BOTTOM part (blocks)
    pymunk.Segment(
        space.static_body,
        (FINISH_X, gap_bottom),
        (FINISH_X, HEIGHT),
...
while running:
    ...
    for ball in balls:
        ...
        # Winner detection
        if x + 2*r >= FINISH_X and gap_top < y < gap_bottom and not winner_found:
